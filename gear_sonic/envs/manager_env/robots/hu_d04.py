...
HU_D04_ISAACLAB_TO_MUJOCO_DOF = [
    ...
    15,  # IL 11 head_yaw            -> MJ 15  (empirically verified via IL joint table)
    17,  # IL 12 left_shoulder_pitch -> MJ 17
    24,  # IL 13 right_shoulder_pitch-> MJ 24
    4,   # IL 14 left_ankle_pitch    -> MJ  4
    10,  # IL 15 right_ankle_pitch   -> MJ 10
    16,  # IL 16 head_pitch          -> MJ 16
    18,  # IL 17 left_shoulder_roll  -> MJ 18
    25,  # IL 18 right_shoulder_roll -> MJ 25
...
HU_D04_MUJOCO_TO_ISAACLAB_DOF = [
    ...
    11,  # MJ 15 head_yaw            -> IL 11  (empirically verified)
    16,  # MJ 16 head_pitch          -> IL 16
    12,  # MJ 17 left_shoulder_pitch -> IL 12
    17,  # MJ 18 left_shoulder_roll  -> IL 17
    ...
    13,  # MJ 24 right_shoulder_pitch-> IL 13
    18,  # MJ 25 right_shoulder_roll -> IL 18
...
HU_D04_ISAACLAB_TO_MUJOCO_BODY = [
    ...
    16,  # IL 12 head_yaw_link           -> MJ 16  (empirically verified via body_names)
    18,  # IL 13 left_shoulder_pitch_link -> MJ 18
    25,  # IL 14 right_shoulder_pitch_link-> MJ 25
    5,   # IL 15 left_ankle_pitch_link   -> MJ  5
    11,  # IL 16 right_ankle_pitch_link  -> MJ 11
    17,  # IL 17 head_pitch_link         -> MJ 17
    19,  # IL 18 left_shoulder_roll_link -> MJ 19
    26,  # IL 19 right_shoulder_roll_link-> MJ 26
...
HU_D04_MUJOCO_TO_ISAACLAB_BODY = [
    ...
    12,  # MJ 16 head_yaw_link           -> IL 12  (empirically verified via body_names)
    17,  # MJ 17 head_pitch_link         -> IL 17
    13,  # MJ 18 left_shoulder_pitch_link -> IL 13
    18,  # MJ 19 left_shoulder_roll_link -> IL 18
    ...
    14,  # MJ 25 right_shoulder_pitch_link-> IL 14
    19,  # MJ 26 right_shoulder_roll_link-> IL 19
